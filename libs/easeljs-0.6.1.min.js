...
(function(){var c=function(a,l,b,d,e,c){this.initialize(a,l,b,d,e,c)},b=c.prototype;c.identity=null;c.DEG_TO_RAD=Math.PI/180;b.a=1;b.b=0;b.c=0;b.d=1;b.tx=0;b.ty=0;b.alpha=1;b.shadow=null;b.compositeOperation=null;b.initialize=function(a,l,b,d,e,c){null!=a&&(this.a=a);this.b=l||0;this.c=b||0;null!=d&&(this.d=d);this.tx=e||0;this.ty=c||0;return this};b.prepend=function(a,l,b,d,e,c){var g=this.tx;if(1!=a||0!=l||0!=b||1!=d){var k=this.a,j=this.c;this.a=k*a+this.b*b;this.b=k*l+this.b*d;this.c=j*a+this.d*
b;this.d=j*l+this.d*d}this.tx=g*a+this.ty*b+e;this.ty=g*l+this.ty*d+c;return this};b.append=function(a,l,b,d,e,c){var g=this.a,k=this.b,j=this.c,m=this.d;this.a=a*g+l*j;this.b=a*k+l*m;this.c=b*g+d*j;this.d=b*k+d*m;this.tx=e*g+c*j+this.tx;this.ty=e*k+c*m+this.ty;return this};b.prependMatrix=function(a){this.prepend(a.a,a.b,a.c,a.d,a.tx,a.ty);this.prependProperties(a.alpha,a.shadow,a.compositeOperation);return this};b.appendMatrix=function(a){this.append(a.a,a.b,a.c,a.d,a.tx,a.ty);this.appendProperties(a.alpha,
...
this;a.parent;)a=a.parent;return a instanceof createjs.Stage?a:null};b.localToGlobal=function(a,b,c){var d=this.getConcatenatedMatrix(this._matrix);if(null==d)return null;d.append(1,0,0,1,a,b);return c?(c.x=d.tx,c.y=d.ty,c):new createjs.Point(d.tx,d.ty)};b.globalToLocal=function(a,b,c){var d=this.getConcatenatedMatrix(this._matrix);if(null==d)return null;d.invert();d.append(1,0,0,1,a,b);return c?(c.x=d.tx,c.y=d.ty,c):new createjs.Point(d.tx,d.ty)};b.localToLocal=function(a,b,c,d){a=this.localToGlobal(a,
b,d);return c.globalToLocal(a.x,a.y,a)};b.setTransform=function(a,b,c,d,e,f,g,k,j){this.x=a||0;this.y=b||0;this.scaleX=null==c?1:c;this.scaleY=null==d?1:d;this.rotation=e||0;this.skewX=f||0;this.skewY=g||0;this.regX=k||0;this.regY=j||0;return this};b.getMatrix=function(a){return(a?a.identity():new createjs.Matrix2D).appendTransform(this.x,this.y,this.scaleX,this.scaleY,this.rotation,this.skewX,this.skewY,this.regX,this.regY).appendProperties(this.alpha,this.shadow,this.compositeOperation)};b.getConcatenatedMatrix=
function(a){a?a.identity():a=new createjs.Matrix2D;for(var b=this;null!=b;)a.prependTransform(b.x,b.y,b.scaleX,b.scaleY,b.rotation,b.skewX,b.skewY,b.regX,b.regY).prependProperties(b.alpha,b.shadow,b.compositeOperation),b=b.parent;return a};b.hitTest=function(a,b){if(this.hitRect)return this.hitRect.contains(a,b);var h=c._hitTestContext;h.setTransform(1,0,0,1,-a,-b);this.draw(h);var d=this._testHit(h);h.setTransform(1,0,0,1,0,0);h.clearRect(0,0,2,2);return d};b.set=function(a){for(var b in a)this[b]=
a[b];return this};b.clone=function(){var a=new c;this.cloneProps(a);return a};b.toString=function(){return"[DisplayObject (name="+this.name+")]"};b.cloneProps=function(a){a.alpha=this.alpha;a.name=this.name;a.regX=this.regX;a.regY=this.regY;a.rotation=this.rotation;a.scaleX=this.scaleX;a.scaleY=this.scaleY;a.shadow=this.shadow;a.skewX=this.skewX;a.skewY=this.skewY;a.visible=this.visible;a.x=this.x;a.y=this.y;a.mouseEnabled=this.mouseEnabled;a.compositeOperation=this.compositeOperation;this.cacheCanvas&&
(a.cacheCanvas=this.cacheCanvas.cloneNode(!0),a.cacheCanvas.getContext("2d").putImageData(this.cacheCanvas.getContext("2d").getImageData(0,0,this.cacheCanvas.width,this.cacheCanvas.height),0,0))};b._applyShadow=function(a,b){b=b||Shadow.identity;a.shadowColor=b.color;a.shadowOffsetX=b.offsetX;a.shadowOffsetY=b.offsetY;a.shadowBlur=b.blur};b._tick=function(a){this.onTick&&this.onTick.apply(this,a);var b=this._listeners;b&&b.tick&&this.dispatchEvent({type:"tick",params:a})};b._testHit=function(a){try{var b=
1<a.getImageData(0,0,1,1).data[3]}catch(h){if(!c.suppressCrossDomainErrors)throw"An error has occurred. This is most likely due to security restrictions on reading canvas pixel data with local or cross-domain images.";}return b};b._applyFilters=function(){if(this.filters&&0!=this.filters.length&&this.cacheCanvas)for(var a=this.filters.length,b=this.cacheCanvas.getContext("2d"),c=this.cacheCanvas.width,d=this.cacheCanvas.height,e=0;e<a;e++)this.filters[e].applyFilter(b,0,0,c,d)};b._hasMouseHandler=
...
c._IE_disable(b))};c._IOS_enable=function(b){var a=b.canvas,l=b.__touch.f=function(a,d){c._IOS_handleEvent(b,a,d)};a.addEventListener("touchstart",l,!1);a.addEventListener("touchmove",l,!1);a.addEventListener("touchend",l,!1);a.addEventListener("touchcancel",l,!1)};c._IOS_disable=function(b){var a=b.canvas;a&&(b=b.__touch.f,a.removeEventListener("touchstart",b,!1),a.removeEventListener("touchmove",b,!1),a.removeEventListener("touchend",b,!1),a.removeEventListener("touchcancel",b,!1))};c._IOS_handleEvent=
function(b,a,c){if(b){b.__touch.preventDefault&&a.preventDefault&&a.preventDefault();for(var h=a.changedTouches,d=a.type,e=0,f=h.length;e<f;e++){var g=h[e],k=g.identifier;if(c||g.target==b.canvas)"touchstart"==d?this._handleStart(b,k,a,g.pageX,g.pageY):"touchmove"==d?this._handleMove(b,k,a,g.pageX,g.pageY):("touchend"==d||"touchcancel"==d)&&this._handleEnd(b,k,a)}}};c._IE_enable=function(b){var a=b.canvas,l=b.__touch.f=function(a,d){c._IE_handleEvent(b,a,d)};a.addEventListener("MSPointerDown",l,!1);
window.addEventListener("MSPointerMove",l,!1);window.addEventListener("MSPointerUp",l,!1);window.addEventListener("MSPointerCancel",l,!1);b.__touch.preventDefault&&(a.style.msTouchAction="none");b.__touch.activeIDs={}};c._IE_disable=function(b){var a=b.__touch.f;window.removeEventListener("MSPointerMove",a,!1);window.removeEventListener("MSPointerUp",a,!1);window.removeEventListener("MSPointerCancel",a,!1);b.canvas&&b.canvas.removeEventListener("MSPointerDown",a,!1)};c._IE_handleEvent=function(b,
a,c){if(b){b.__touch.preventDefault&&a.preventDefault&&a.preventDefault();var h=a.type,d=a.pointerId,e=b.__touch.activeIDs;if("MSPointerDown"==h){if(c||a.srcElement==b.canvas)e[d]=!0,this._handleStart(b,d,a,a.pageX,a.pageY)}else if(e[d])if("MSPointerMove"==h)this._handleMove(b,d,a,a.pageX,a.pageY);else if("MSPointerUp"==h||"MSPointerCancel"==h)delete e[d],this._handleEnd(b,d,a)}};c._handleStart=function(b,a,c,h,d){c.preventDefault();var e=b.__touch;if(e.multitouch||!e.count){var f=e.pointers;f[a]||
(f[a]=!0,e.count++,b._handlePointerDown(a,c,h,d))}};c._handleMove=function(b,a,c,h,d){c.preventDefault();b.__touch.pointers[a]&&b._handlePointerMove(a,c,h,d)};c._handleEnd=function(b,a,c){c.preventDefault();var h=b.__touch,d=h.pointers;d[a]&&(h.count--,b._handlePointerUp(a,c,!0),delete d[a])};createjs.Touch=c})();(function(){var c=this.createjs=this.createjs||{},c=c.EaselJS=c.EaselJS||{};c.version="0.6.1";c.buildDate="Wed, 12 Feb 2014 20:58:34 GMT"})();
